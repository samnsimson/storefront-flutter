...
const GetCart = _i1.OperationDefinitionNode(
  ...
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'cartId')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
    ...
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'guestId')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'String'),
        isNonNull: false,
      ),
    ...
    _i1.FieldNode(
      ...
      arguments: [
        ...
        _i1.ArgumentNode(
          ...
          value: _i1.VariableNode(name: _i1.NameNode(value: 'cartId')),
        ),
        _i1.ArgumentNode(
          name: _i1.NameNode(value: 'guestId'),
          value: _i1.VariableNode(name: _i1.NameNode(value: 'guestId')),
        ),
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [
